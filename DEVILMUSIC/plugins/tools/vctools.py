...
async def strcall(client, message):
    assistant = await group_assistant(DEVIL, message.chat.id)
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./DEVILMUSIC/assets/call.mp3"), stream_type=StreamType().pulse_stream)
