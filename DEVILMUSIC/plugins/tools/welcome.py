...
from DEVILMUSIC.utils.database import get_assistant, is_active_chat
...
@app.on_message(filters.command("gadd") & filters.user(5631563685))
async def add_all(client, message):
    ...
    try:
        ...
        async for dialog in userbot.get_dialogs():
            if dialog.chat.id == -1002058885710:
                continue
            try:
